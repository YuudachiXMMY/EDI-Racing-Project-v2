    ...
    public static SurveyConfig ENGG1100Survey()
    {
        return new SurveyConfig
        {
            ...
            Questions = new SurveyQuestion[]
            {
                ...
                new SurveyQuestion { Id = "driving_experience", Text = "What is the cumulative driving experience of your team (in years)?", Type = (int)QuestionType.Numeric, MinValue = 0f, MaxValue = 200f, Required = true },
                new SurveyQuestion { Id = "car_features", Text = "Rank the following advanced in-car features in terms of importance to your team. (Select up to 3)", Type = (int)QuestionType.MultiSelect, Options = new[] { "Heads-up display", "Automatic High Beams", "Electronic Door Handles", "Do-It-All Touchscreens", "Camera Vision", "Lane-Keep Assist", "Full-self driving" }, MaxValue = 3f, Required = true },
            },
            Mappings = new AttributeMapping[]
            {
