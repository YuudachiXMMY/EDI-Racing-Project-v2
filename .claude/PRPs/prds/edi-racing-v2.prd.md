...
|---|-------|-------------|--------|----------|---------|----------|
| 1 | Core Racing Loop | Car spawning, NavMesh movement, checkpoint system, scoring | in-progress | - | - | [core-racing-loop.plan.md](../plans/core-racing-loop.plan.md) |
| 2 | Event System | 7 pre-configurable event types with live triggering | pending | with 3, 4 | 1 | - |
