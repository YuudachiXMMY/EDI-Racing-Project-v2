...
| 6 | Student 2D wiring | Route the 2D spectator (`/live/:roomCode`) from the landing page | in-progress (plan created) | with 5 | 4 | `.claude/PRPs/plans/student-2d-wiring.plan.md` |
