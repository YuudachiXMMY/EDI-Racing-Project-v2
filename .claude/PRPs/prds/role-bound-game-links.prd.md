...
| 4 | Student link + landing page | Auto-generate student link (room code, no token); landing page with 3D/2D choice | in-progress | - | 2 | `.claude/PRPs/plans/student-link-landing-page.plan.md` |
