...
| 5 | Student Unity auto-join + role lock | 3D path auto-joins via URL room code, hides Host/EventPanel, hard-locks non-host role | in-progress (plan created) | with 6 | 4 | `.claude/PRPs/plans/student-unity-auto-join-role-lock.plan.md` |
